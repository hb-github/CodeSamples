...
export class DashboardHomeComponent implements OnInit {
  ...
  private salesChart() {
    const saleChart = new Chart(document.getElementById('month-sales-chart'), {
      type: 'line',
      data: {
  ...
  private dayChart() {
    const dayChart = new Chart(document.getElementById('day-sales-chart'), {
      type: 'line',
      data: {
        labels: [0, 20, 40, 30, 10, 25, 36],
        datasets: [
  ...
  private fullChart() {
    const fullChart = new Chart(document.getElementById('full-chart'), {
      type: 'line',
      data: {
